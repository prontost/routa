...
from counta.core import notifications
from counta.web.api.dependencies import current_tenant
...
async def unread_count(app: str = "counta", tenant_id: int = Depends(current_tenant)):
