...
>
> Last updated: 2026-06-23 — class-based architecture rules added; tenant/user refactor follows Counta.
...
from routa.core.trip_service import TripService
from routa.web.api.dependencies import get_trip_service
